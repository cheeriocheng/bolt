    ...
    exports.transformSVGPath =
        function transformSVGPath(pathStr) {
            ...
            var idx = 1, len = pathStr.length, activeCmd,
                x = 0, y = 0, nx = 0, ny = 0, firstX = 0, firstY = 0,
                x1 = 0, x2 = 0, y1 = 0, y2 = 0,
...
var initSVGObject = function() {
    ...
    //obj.paths = ["M0,0a300,300,0,0,0,150,0"];
    //obj.paths = ["M600,350 l 50,-25 a25,25 -30 0,1 50,-25 l 50,-25 a25,50 -30 0,1 50,-25 l 50,-25 a25,75 -30 0,1 50,-25 l 50,-25 a25,100 -30 0,1 50,-25 l 50,-25"];
    obj.paths = ["M300,200 h-150 a150,150 0 1,0 150,-150 z"];
    //obj.paths = ["M330.08,247.72H147.42L213.34,0H79.14L2.61,287.91c-11.44,43.3,15.85,78.74,60.64,78.74H146.5L93.25,568.28Za2.37,2.37,0,0,0,4.18,2"];//L334.78,257.17A5.89,5.89,0,0,0,330.08,247.72ZM57.6,309.46l75.88-282.2h11.28l-73,271.3H232.08a5.45,5.45,0,0,1,5.45,5.45h0a5.45,5.45,0,0,1-5.45,5.45Z"];
